...
Private Sub Form_Load()
  ...
  adoPrimaryRS.Open "select C1_TIPO_PROD,C1_FECHA_TARJ,C1_FECHA_ENTREGA,C1_LOTE_ANT,C1_LOTE_PROX,C1_ORDEN_FAB,C1_NOMBRE_CLIENTE,C1_TIPO,to_number(C1_ANCHO) Ancho,C1_DIAMETRO,to_number(C1_PESO) Peso,to_number(C1_PESO_AUX) Peso_Aux,to_number(C1_PESO_ATADO) Peso_Atado,to_number(C1_PESO_ATADO_AUX) Peso_Atado_Aux,to_number(C1_LONGITUD) Longitud,C1_ESPACIAM,C1_CANTIDAD,C1_CANTIDAD_AUX,C1_MAQUINA,C1_TURNO,C1_LENGUAJE from INVTARJ01_DAT order by C1_TIPO_PROD, C1_FECHA_TARJ", db, adOpenStatic, adLockOptimistic
