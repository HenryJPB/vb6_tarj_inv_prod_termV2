...
Begin VB.Form iNVTARJ01v2_FRM 
   ...
   Begin VB.CommandButton Boton_Catalogo 
      Height          =   375
      Left            =   3360
      Picture         =   "INVTARJ01v2_FRM.frx":001F
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   2160
      Width           =   495
   ...
   Begin VB.CommandButton Boton_Cancelar 
      ...
      Height          =   495
      Left            =   4320
      Picture         =   "INVTARJ01v2_FRM.frx":0461
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   5400
      Width           =   855
   ...
   Begin VB.CommandButton Boton_Imprimir 
      ...
      Height          =   495
      Left            =   3000
      Picture         =   "INVTARJ01v2_FRM.frx":05D3
      Style           =   1  'Graphical
      TabIndex        =   23
      Top             =   5400
      Width           =   855
   ...
   Begin VB.PictureBox picStatBox 
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   300
         Left            =   4560
         Picture         =   "INVTARJ01v2_FRM.frx":0B05
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   300
         Left            =   4200
         Picture         =   "INVTARJ01v2_FRM.frx":0C97
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   300
         Left            =   360
         Picture         =   "INVTARJ01v2_FRM.frx":0E29
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   300
         Left            =   0
         Picture         =   "INVTARJ01v2_FRM.frx":0FBB
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   0
         UseMaskColor    =   -1  'True
...
'*  Actualizado el 15 de Enero del año 2004.
'*  * NOTA IMPORTANTE: Esta aplicacion requiere que la tabla
...
Private Sub INICIALIZAR_VALORES()
   ...
   If (adoPrimaryRS.RecordCount > 0) Then
      ...
      Cadena1 = "select C1_LOTE_ANT, C1_LOTE_PROX " & _
                "from   INVTARJ01_DAT " & _
                "where  C1_TIPO_PROD = '" & Form2.Combo1.Text & "' " & _
   ...
   Select Case Form2.Combo1.Text
          ...
          Case "MP", "MR*"    'MR*->Malla en Rollo especial.
               '
               txtFields(4).Enabled = True
...
Public Sub cmdUpdate_Click()
  ...
  adoPrimaryRS("C1_FECHA_ENTREGA") = Form2.Text1.Text
...
Private Sub VALIDAR_ORDEN_FAB()
  ...
  'Coneccion2.Open "PROVIDER=MSDASQL;dsn=DESICA733;uid=ops$desinv02;pwd=ops$desinv02;"
  Set Q1 = New Recordset
  '*---------------------------------------------------------
...
Private Sub CHECK_ITEM_IMPRESO()
  ...
  'Coneccion3.Open "PROVIDER=MSDASQL;dsn=DESICA815;uid=ops$desinv02;pwd=ops$desinv02;"
...
Sub VALIDAR_ITEM_ORDEN()
  ...
  If Char_Pos > 0 Then
     Mid(Cod_Prod, Char_Pos) = "_"
     ClausulaSQL = "select C4_TAML Longitud, C4_TAMT Ancho, " & _
                       "C4_NUML Numl, C4_NUMT Numt, " & _
                       "C4_DIAML Diaml, C4_DIAMT Diamt, " & _
  ...
  If (Q2.RecordCount > 0) Then
      adoPrimaryRS("C1_ANCHO") = Str(Q2("Ancho"))
      Ancho = Q2("Ancho")
      Numt = Q2("Numt")
      Diamt = Q2("Diamt")
      adoPrimaryRS("C1_LONGITUD") = Str(Q2("Longitud"))
      Longitud = Q2("Longitud")
      Numl = Q2("Numl")
      Diaml = Q2("Diaml")
      adoPrimaryRS("C1_DIAMETRO") = Q2("Diam")
      adoPrimaryRS("C1_ESPACIAM") = Q2("Espaciam")
      adoPrimaryRS("C1_CANTIDAD") = Str(Q2("Cantidad"))
      adoPrimaryRS("C1_CANTIDAD_AUX") = Str(Q2("Cantidad"))
      PesoT = Ancho * Numt * (Diamt * Diamt) * Const_Peso
      PesoL = Longitud * Numl * (Diaml * Diaml) * Const_Peso
      adoPrimaryRS("C1_PESO") = PesoT + PesoL
      adoPrimaryRS("C1_PESO_AUX") = PesoT + PesoL
      adoPrimaryRS("C1_PESO_ATADO") = (PesoT + PesoL) * Q2("Cantidad")
      adoPrimaryRS("C1_PESO_ATADO_AUX") = (PesoT + PesoL) * Q2("Cantidad")
      CHECK_ITEM_IMPRESO
  Else
...
Private Sub CALCULAR_PESO_ATADO()
   ...
   'Peso del atado:
   If (Not IsNull(txtFields(8))) And (Not IsNull(txtFields(11))) Then
...
Private Sub txtFields_LostFocus(Index As Integer)
   ...
   If (Index = 2) And Not IsNull(txtFields(2).Text) Then
           txtFields(3).Text = Val(txtFields(2).Text) + Val(Form2.Text2.Text) - 1
           adoPrimaryRS("C1_LOTE_PROX") = txtFields(3)
   'ElseIf (Index = 4) And (Len(txtFields(4))) Then
           'VALIDAR_ORDEN_FAB -->  temporal, no hay sistema remoto.
   'ElseIf (Index = 5) And (Form2.Combo1.Text = "MP") Then
           'VALIDAR_ITEM_ORDEN --> temporal no hey sistema remoto.
   ElseIf (Index = 6) Then
...
Private Sub IMPRIMIR_TARJETAS()
    ...
    CadenaSQL = "select C0_NORMA " & _
                ...
                "where  C0_TIPO_PROD ='" & txtFields(0) & "' "
    '* Chequear query:
    'MsgBox CadenaSQL
...
Private Sub PRINT_AT(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        Lineas_Entre_Tarjetas = 5 '<: Valor for W98.
        Lote = Format(i, "00000") + "-" + txtFields(0) + "-" + Format(txtFields(1), "YY")
        Printer.Print Tab(N1); "DESIGNACION: " + Designacion; Tab(N3); Tab(N3); Lote
        Printer.Print Tab(N1); TxtCliente + Mid(txtFields(18).Text, 1, 18); Tab(N3); "D: " + txtFields(7)
        Printer.Print Tab(N1); "TIPO: " + txtFields(5); Tab(N2); "DIAMETRO: " + txtFields(7) + " (mm)"; Tab(N3); "L: " + Format(txtFields(9), "###,##0.00")
        ...
        Printer.Print Tab(N3); "Ref.:__________."
        Printer.Print Tab(N1); "No. Referencia:_______________."
        Printer.Print Tab(N3); "Peso:__________."
        '
        Contador = Contador + 1
        If (Contador = Punto_Ajuste) Then
            'Lineas_Entre_Tarjetas = Lineas_Entre_Tarjetas -1 '<: Valor for WNT
            Lineas_Entre_Tarjetas = Lineas_Entre_Tarjetas - 3 '<: Valor for W98.
            Contador = 0
        End If
...
Private Sub PRINT_CE(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        Printer.Print Tab(N1); "DESIGNACION: " + Designacion; Tab(N3); Tab(N3); Lote
        Printer.Print
        Printer.Print Tab(N1); "TIPO: " + txtFields(5); Tab(N2); "LONGITUD: " + Format(txtFields(9), "###,##0.00") + " (m)"; Tab(N3); "L: " + Format(txtFields(9), "###,##0.00")
        Printer.Print
        Printer.Print Tab(N1); "ALTURA: " + Format(txtFields(6), "###,##0.00") + " (cm)"; Tab(N2); "CANTIDAD: " + txtFields(11) + " (und)"; Tab(N3); "A: " + Format(txtFields(6), "###,##0.00")
        Printer.Print
        Printer.Print Tab(N1); "NORMA: " + Norma; Tab(N2); "LOTE: " + Lote; Tab(N3); "C: " + txtFields(11)
        Contador = Contador + 1
        If (Contador = Punto_Ajuste) Then
            'Lineas_Entre_Tarjetas = Lineas_Entre_Tarjetas - 1
            Lineas_Entre_Tarjetas = Lineas_Entre_Tarjetas - 3
            Contador = 0
        End If
        For R = 1 To Lineas_Entre_Tarjetas
            Printer.Print
...
Private Sub PRINT_MP(Norma As String)
   ...
   Punto_Ajuste = 3  '<: Valor for W98
   Contador = 0
   Contador_Atds = Val(Form2.Text3.Text) - 1
   Cont_Atds_Hasta = Str(Val(Form2.Text2.Text) + Val(Form2.Text3.Text) - 1)
   Printer.Print
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        Lote = Format(i, "00000") + "-" + txtFields(0) + "-" + Format(txtFields(1), "YY")
        Printer.Print Tab(N1); TxtDesig + Designacion; Tab(N2); TxtCliente + Mid(txtFields(18).Text, 1, 28); Tab(N3); Lote
        ...
        If (i = txtFields(3)) Then  ' Ultimo atado
            Printer.Print Tab(N1); TxtDiam + txtFields(7) + " (mm)"; Tab(N2); TxtSep + txtFields(10) + " mm"; Tab(N3); "C: " + txtFields(15)
        ...
        Else
            Printer.Print Tab(N1); TxtDiam + txtFields(7) + " (mm)"; Tab(N2); TxtSep + txtFields(10) + " mm"; Tab(N3); "C: " + txtFields(11)
...
Private Sub PRINT_MR_ESPECIAL(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        If (i = txtFields(3)) Then  ' Ultimo atado
            ...
            Printer.Print Tab(N1); TxtPeso + Format(txtFields(14), "###,##0.00") + " (kg)"; Tab(N2); TxtCant + txtFields(15) + " (und)"; Tab(N3); "ATD: " + Str(Contador_Atds) + "/" + Cont_Atds_Hasta
            'Printer.Print Tab(N1); TxtNorma + Norma; Tab(N2); TxtLote + Lote; Tab(N3); "P: " + Format(txtFields(17), "###,##0.00")
            Printer.Print Tab(N1); Norma; Tab(N2); TxtLote + Lote; Tab(N3); "P: " + Format(txtFields(17), "###,##0.00")
        Else
            Printer.Print Tab(N1); TxtDiam + txtFields(7) + " (mm)"; Tab(N2); TxtSep + txtFields(10) + " mm"; Tab(N3); "C: " + txtFields(11)
            Printer.Print Tab(N1); TxtPeso + Format(txtFields(8), "###,##0.00") + " (kg)"; Tab(N2); TxtCant + txtFields(11) + " (und)"; Tab(N3); "ATD: " + Str(Contador_Atds) + "/" + Cont_Atds_Hasta
            'Printer.Print Tab(N1); TxtNorma + Norma; Tab(N2); TxtLote + Lote; Tab(N3); "P: " + Format(txtFields(16), "###,##0.00") + " (kg)"
...
Private Sub PRINT_MR(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        'Lineas_Entre_Tarjetas = 3 '<: Valor for WNT
        ...
        Printer.Print Tab(N1); "LONGITUD: " + Format(txtFields(9), "###,##0.00") + " (m)"; Tab(N2); "ANCHO: " + Format(txtFields(6), "###,##0.00") + " (m)"; Tab(N3); txtFields(10)
        Printer.Print Tab(N1); "DIAM: " + txtFields(7) + " (mm)"; Tab(N2); "ESPACIAM: " + txtFields(10)
        Printer.Print Tab(N1); "NORMA: " + Norma; Tab(N2); "LOTE: " + Lote
        Contador = Contador + 1
        If (Contador = Punto_Ajuste) Then
            Lineas_Entre_Tarjetas = Lineas_Entre_Tarjetas - 3
