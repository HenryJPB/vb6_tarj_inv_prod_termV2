...
Begin VB.Form iNVTARJ01v2_FRM 
   ...
   Begin VB.ComboBox ComboLenguaje 
      ...
      Height          =   315
      ItemData        =   "INVTARJ01v3_FRM.frx":0000
      Left            =   5640
      List            =   "INVTARJ01v3_FRM.frx":000A
      TabIndex        =   15
      Text            =   "ESPAÑOL"
      Top             =   3600
      Width           =   1335
   ...
   Begin VB.CommandButton Boton_Catalogo 
      Height          =   375
      Left            =   3360
      Picture         =   "INVTARJ01v3_FRM.frx":001F
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   2160
      Width           =   495
   ...
   Begin VB.CommandButton Boton_Cancelar 
      ...
      Height          =   495
      Left            =   4320
      Picture         =   "INVTARJ01v3_FRM.frx":0461
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   5880
      Width           =   855
   ...
   Begin VB.CommandButton Boton_Imprimir 
      ...
      Height          =   495
      Left            =   3120
      Picture         =   "INVTARJ01v3_FRM.frx":05D3
      Style           =   1  'Graphical
      TabIndex        =   23
      Top             =   5880
      Width           =   855
   ...
   Begin VB.PictureBox picStatBox 
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   300
         Left            =   4560
         Picture         =   "INVTARJ01v3_FRM.frx":0B05
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   300
         Left            =   4200
         Picture         =   "INVTARJ01v3_FRM.frx":0C97
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   300
         Left            =   360
         Picture         =   "INVTARJ01v3_FRM.frx":0E29
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   300
         Left            =   0
         Picture         =   "INVTARJ01v3_FRM.frx":0FBB
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   0
         UseMaskColor    =   -1  'True
...
'*  Actualizado el 11 de Enero del año 2005.
...
Private Sub PRINT_AT(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        Printer.Print Tab(N1); "NORMA: " + Norma; Tab(N2); "LOTE: " + Lote; Tab(N3); "Ref.:__________."
        Printer.Print
        Printer.Print Tab(N1); "No. Referencia:_______________."; Tab(N3); "Peso:__________."
        Printer.Print
        Printer.Print Tab(N3); "Fecha:__________."
        '
        Contador = Contador + 1
...
Private Sub PRINT_CE(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        Printer.Print Tab(N1); "TIPO: " + txtFields(5); Tab(N2); "LONGITUD: " + Format(txtFields(9), "###,##0.00") + " (m)"; Tab(N3); "A: " + Format(txtFields(6), "###,##0.00")
        Printer.Print Tab(N3); "C: " + txtFields(11)
        Printer.Print Tab(N1); "ALTURA: " + Format(txtFields(6), "###,##0.00") + " (cm)"; Tab(N2); "CANTIDAD: " + txtFields(11) + " (und)"
        Printer.Print
        Printer.Print Tab(N1); "NORMA: " + Norma; Tab(N2); "LOTE: " + Lote; Tab(N3); "Fecha: ______________."
        Contador = Contador + 1
        If (Contador = Punto_Ajuste) Then
