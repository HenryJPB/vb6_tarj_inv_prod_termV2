...
'*  Actualizado el 24 de Octubre del año 2005.
...
Private Sub PRINT_CE(Norma As String)
   ...
   For i = txtFields(2) To txtFields(3)
        ...
        Printer.Print Tab(N1); "TIPO: " + txtTipoCercha; Tab(N2); "LONGITUD: " + Format(txtFields(9), "###,##0.00") + " (m)"; Tab(N3); "A: " + Format(txtFields(6), "###,##0.00")
